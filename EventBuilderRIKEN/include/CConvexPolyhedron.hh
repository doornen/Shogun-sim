...
class CConvexPolyhedron : public G4CSGSolid
{
  ...
  public:
    ...
    CConvexPolyhedron(const CConvexPolyhedron& orig);                       // copy constructor

    CConvexPolyhedron(const G4String& pName, const G4Point3DVector* pVec);  // Constructor for MarsView
