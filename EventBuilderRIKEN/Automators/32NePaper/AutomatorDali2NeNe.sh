...
INPUTFILE="INPUTFILE ../SimulationResults/Generator/32ne/32ne_32ne241mev_700kev"
FILEEXT1="ps.root"
OUTPUTFILE="OUTPUTFILE ../SimulationResults/Builder/dali2/32ne/32ne_32ne241mev_700kev_nores"
