...
void ShowEfficiencyAndResolution(int caseNumber,int eventSimulated,int binning)  {  
  char dummyText[1000];
  ...
  GraphTotal->GetYaxis()->SetRangeUser(10,80);
