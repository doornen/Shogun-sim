...
//_________________________________________________________________________________________________
void RisingFastBeamReconstructorBetaVar31S()
{ 
  ...
  float decayZ[20]          = 
{0.0,0.029461,0.05773,0.08445,0.1131,0.1395,0.1684,0.1962,0.2245,0.2514,0.2806,0.3068,0.3348,0.3635,0.3894,0.4179,0.4451,0.4736,0.5006,0.5279};
  float betaVar[20] = {0.544,0.5421,0.5405,0.5382,0.5394,0.5366,0.5378,0.536,0.5355,0.5352,0.5347,0.5345,0.5342,0.5339,0.5337,0.5336,0.5333,0.5332,0.5331,0.533};
//-----------------------------------------------------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
  ...
  for(int i = 1240; i<1260;i++)
  {
    for(int j = 0; j<20;j++)
    {
      sprintf(root_out,"/home/doornen/GEANT4/g4.9.0.p01/SimulationResults/Reconstructor/RisingFast/31s/out_events_built_37ca_31s_195mev_%ikev_%ips.root",i,j);
      ...
      //////////////////////////////////////////////////////////////////////////////////////////////////////
      sprintf(root_in,"/home/doornen/GEANT4/g4.9.0.p01/SimulationResults/Builder/RisingFast/31s/events_built_37ca_31s_195mev_%ikev_%ips.root",i,j);
