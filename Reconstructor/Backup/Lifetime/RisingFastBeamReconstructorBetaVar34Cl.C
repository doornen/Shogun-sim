...
//_________________________________________________________________________________________________
void RisingFastBeamReconstructorBetaVar34Cl()
{ 
  ...
  float decayZ[20]          = 
{0.0,0.02836,0.05609,0.0837,0.1112,0.1387,0.1661,0.1935,0.2209,0.2483,0.2757,0.303,0.3304,0.3577,0.3851,0.4124,0.4397,0.4671,0.4944,0.5217};
  float betaVar[20] = {0.5454,0.5434,0.5418,0.5405,0.5394,0.5385,0.5378,0.5372,0.5367,0.5363,0.536,0.5356,0.5354,0.5351,0.5349,0.5347,0.5345,0.5344,0.5342,0.5341};
//-----------------------------------------------------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
  ...
  for(float i = 454.5; i<465;i = i + 0.5)
  {
    for(int j = 0; j<20;j++)
    {
      if((int)(10*i)%10 == 5)
      {
sprintf(root_out,"/home/doornen/GEANT4/g4.9.0.p01/SimulationResults/Reconstructor/RisingFast/34cl/out_events_built_37ca_34cl_195mev_%0.1fkev_%ips.root",i,j);
      }
      else if((int)(10*i)%10 == 0)
      {
      sprintf(root_out,"/home/doornen/GEANT4/g4.9.0.p01/SimulationResults/Reconstructor/RisingFast/34cl/out_events_built_37ca_34cl_195mev_%ikev_%ips.root",(int)i,j);
      }
      ...
      if((int)(10*i)%10 == 5)
      {
        sprintf(root_in,"/media/BOOTCAMP/SimulationResults/Builder/34cl/events_built_37ca_34cl_195mev_%0.1fkev_%ips.root",i,j);
      }
      else if((int)(10*i)%10 == 0)
      {
        sprintf(root_in,"/media/BOOTCAMP/SimulationResults/Builder/34cl/events_built_37ca_34cl_195mev_%ikev_%ips.root",(int)i,j);
      }
